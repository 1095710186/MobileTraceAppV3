...
public class MaterialDialog {
    ...
    private boolean pDismiss = true, nDismiss = true;
    ...
    public MaterialDialog setPositiveButton(int resId, final View.OnClickListener listener, boolean pDismiss) {
        this.pId = resId;
        this.pListener = listener;
        this.pDismiss = pDismiss;
        return this;
    }


    public MaterialDialog setPositiveButton(String text, final View.OnClickListener listener, boolean pDismiss) {
        this.pText = text;
        this.pListener = listener;
        this.pDismiss = pDismiss;
        return this;
    ...
    public MaterialDialog setNegativeButton(int resId, final View.OnClickListener listener, boolean nDismiss) {
        this.nId = resId;
        this.nListener = listener;
        this.nDismiss = nDismiss;
        return this;
    }


    public MaterialDialog setNegativeButton(String text, final View.OnClickListener listener, boolean nDismiss) {
        this.nText = text;
        this.nListener = listener;
        this.nDismiss = nDismiss;
        return this;
...
//                }
            ...
            if (mBackgroundDrawable != null) {
                LinearLayout linearLayout
                        = (LinearLayout) mAlertDialogWindow.findViewById(
                        R.id.material_background);
                ViewHelper.setBackground(linearLayout, mBackgroundDrawable);
        ...
        public void setBackground(Drawable drawable) {
            ...
            ViewHelper.setBackground(linearLayout, drawable);
        }
