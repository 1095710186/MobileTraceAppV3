...
public class JHFoodAdapter extends BaseQuickAdapter<FoodInfo> {
    public JHFoodAdapter() {
    ...
    protected void convert(BaseViewHolder baseViewHolder, FoodInfo foodInfo) {
        ...
        UserManager.getInstance().loadFoodHeadImage(mContext, (ImageView) baseViewHolder.getView(R.id.foodinfo_item_imvhead), foodInfo.getImgId());
