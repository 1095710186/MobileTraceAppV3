...
import static cn.com.bigknow.trade.pos.Immediate.R.id.layout_Xj;
...
public class JhDetail_Activity extends BaseActivity {
    @BindView(R.id.chepaiT)
    TextView tvCe;
    @BindView(R.id.tvT_)
    TextView tvT_;
    @BindView(R.id.zjcpLL_)
    LinearLayout mZjcpLL_;
...
//    @AutoBundleField(required = false)
    ...
    @BindView(R.id.sumitTV)
    LinearLayout onSumitLayout;
    ...
    public void init() {
        tvCe.setText("车牌号");
        tvT_.setText("货物重量");
        mZjcpLL_.setVisibility(View.GONE);
        mZjcpLL.setEnabled(false);
        mZjcpLL.setVisibility(View.GONE);
        mTotalET.setEnabled(false);
        recyclerView.setEnabled(false);
        mNumTV.setEnabled(false);
        onSumitLayout.setEnabled(false);
        onSumitLayout.setVisibility(View.GONE);
        ...
        recyclerView.addOnItemTouchListener(new OnItemClickListener() {
            ...
            public void SimpleOnItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
               ...
               /* if (CommonUtil.isNetWorkConnected(mActivity)) {
                    getVendorData(mAdapter.getItem(i)); //查询对应的产地列表
                } else {
...
//                refreshLayout.setRefreshing(false);
    ...
    private void showDialog(FoodInfo foodInfo, List<VendorAreaBean> vendorAreaBeanList) {
        ...
        cdgysAdapter = new CDGYSAdapter();
        refreshLayout.setAdapter(cdgysAdapter);
        if (foodInfo != null && foodInfo.getVendorId() != null) {
            cdgysAdapter.setSelectAreaBeanId(foodInfo.getVendorId());
        }
...
//        PhotoUtil.open(this, true, 1);
        url_gp_path=  PhotoUtil.takePhoto(JhDetail_Activity.this);
