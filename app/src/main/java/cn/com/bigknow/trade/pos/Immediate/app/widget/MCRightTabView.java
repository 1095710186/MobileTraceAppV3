...
public class MCRightTabView extends LinearLayout {
    ...
    public MCRightTabView(Context context) {
        super(context);
        init();
    }

    public MCRightTabView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public MCRightTabView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public MCRightTabView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init() {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.mc_right_tab_layout, null);
        ...
        badgeView1.setBadgeGravity(Gravity.TOP | Gravity.LEFT);
        badgeView1.setBadgeMargin(2, 0, 0, 0);

        badgeView2.setBadgeGravity(Gravity.TOP | Gravity.LEFT);
        badgeView2.setBadgeMargin(2, 10, 0, 0);
        badgeView2.setBackground(50, Color.parseColor("#d3321b"));
        badgeView3.setBadgeGravity(Gravity.TOP | Gravity.LEFT);
        badgeView3.setBadgeMargin(2, 10, 0, 0);
        badgeView3.setBackground(50, Color.parseColor("#d3321b"));
        badgeView4.setBadgeGravity(Gravity.TOP | Gravity.LEFT);
        badgeView4.setBadgeMargin(2, 10, 0, 0);
        badgeView4.setBackground(50, Color.parseColor("#d3321b"));
        badgeView5.setBadgeGravity(Gravity.TOP | Gravity.LEFT);
        badgeView5.setBadgeMargin(2, 10, 0, 0);
