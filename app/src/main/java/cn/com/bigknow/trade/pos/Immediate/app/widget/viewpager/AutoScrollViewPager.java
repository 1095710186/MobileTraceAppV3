package cn.com.bigknow.trade.pos.Immediate.app.widget.viewpager;
...
public class AutoScrollViewPager extends ViewPager {
    ...
    private final static class MyHandler extends Handler {
        ...
        private final WeakReference<AutoScrollViewPager> mViews;

        public MyHandler(AutoScrollViewPager view) {
            mViews = new WeakReference<AutoScrollViewPager>(view);
        }
